/*
 ...
 POSIX 2.10 Utilización de la llamada sigaction para cambiar el comportamiento
 del proceso frente a la recepción de una señal.
*/
#include <errno.h>
#include <signal.h>
#include <stdio.h>
...
int main(int argc, char *argv[]) {
  ...
  // Inicializar la estructura sig_USR_na para especificar la nueva acción para
  // la señal.
